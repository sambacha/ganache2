...
declare class KeyInfo extends SerializableObject<KeyInfoConfig> implements DeserializedObject<KeyInfoConfig> {
    get config(): Definitions<KeyInfoConfig>;
    constructor(options?: Partial<SerializedObject<KeyInfoConfig>> | Partial<DeserializedObject<KeyInfoConfig>>);
    type: KeyType;
    privateKey: Buffer;
}
