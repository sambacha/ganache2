...
import { Address, AddressProtocol, SerializedAddress, AddressNetwork } from "./address";
import { Balance, SerializedBalance } from "./balance";
import { Definitions, DeserializedObject, SerializableObject, SerializedObject } from "./serializable-object";
...
declare class Account extends SerializableObject<AccountConfig> implements DeserializedObject<AccountConfig> {
    #private;
    get config(): Definitions<AccountConfig>;
    static random(defaultFIL: number, rng?: RandomNumberGenerator, protocol?: AddressProtocol, network?: AddressNetwork): Account;
