...
declare type SerializedLiteral<C extends BaseConfig> = C["type"] extends bigint | Buffer ? string : Literal<C>;
...
declare abstract class SerializableLiteral<C extends BaseConfig> implements Serializable<SerializedLiteral<C>> {
