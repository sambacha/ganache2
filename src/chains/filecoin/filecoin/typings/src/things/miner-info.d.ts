...
declare class MinerInfo extends SerializableObject<MinerInfoConfig> implements DeserializedObject<MinerInfoConfig> {
    get config(): Definitions<MinerInfoConfig>;
    constructor(options?: Partial<SerializedObject<MinerInfoConfig>> | Partial<DeserializedObject<MinerInfoConfig>>);
    /**
