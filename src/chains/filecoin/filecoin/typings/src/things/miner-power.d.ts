...
declare class MinerPower extends SerializableObject<MinerPowerConfig> implements DeserializedObject<MinerPowerConfig> {
    get config(): Definitions<MinerPowerConfig>;
    constructor(options?: Partial<SerializedObject<MinerPowerConfig>> | Partial<DeserializedObject<MinerPowerConfig>>);
