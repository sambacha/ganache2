...
declare class Version extends SerializableObject<VersionConfig> implements DeserializedObject<VersionConfig> {
    get config(): Definitions<VersionConfig>;
    constructor(options?: Partial<SerializedObject<VersionConfig>> | Partial<DeserializedObject<VersionConfig>>);
    version: string;
    apiVersion: number;
    blockDelay: bigint;
}
