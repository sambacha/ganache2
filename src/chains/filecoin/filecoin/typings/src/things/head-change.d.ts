...
declare class HeadChange extends SerializableObject<HeadChangeConfig> implements DeserializedObject<HeadChangeConfig> {
    get config(): Definitions<HeadChangeConfig>;
    constructor(options?: Partial<SerializedObject<HeadChangeConfig>> | Partial<DeserializedObject<HeadChangeConfig>>);
    type: string;
    val: Tipset;
}
