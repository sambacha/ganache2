...
export default class AccountManager extends Manager<Account, AccountConfig> {
    #private;
    static initialize(base: LevelUp, privateKeyManager: PrivateKeyManager, database: Database): Promise<AccountManager>;
    constructor(base: LevelUp, privateKeyManager: PrivateKeyManager, database: Database);
